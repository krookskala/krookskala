...
- 🚀 **Engineering Focus**: Computer Science graduate (Software & Database Engineering) with hands-on experience building secure, scalable, cloud-native applications. I specialize in full-stack development with a strong backend and architecture focus.

- 🛠️ **Core Technologies**: I primarily work with **TypeScript, JavaScript, Java, and Python**. My stack includes **React, Vue/Nuxt, Node.js, Prisma ORM, and PostgreSQL**, with a strong emphasis on clean architecture and maintainability.

- ☁️ **Cloud & Serverless**: Experienced in building and deploying serverless APIs using **Cloudflare Workers** and R2 storage. I focus on reliability, performance optimization, and scalable backend systems.

- 🔐 **Security-Oriented Development**: Implemented **Role-Based Access Control (RBAC)**, secure file upload workflows, and vulnerability-aware design (IDOR/BFLA/CORS considerations).

- 🧠 **Problem Solving & System Design**: I enjoy debugging production issues, designing resilient data workflows, and translating domain models into scalable backend systems.

- ⚡ **Beyond Code**: Outside of software engineering, I enjoy creative activities such as cooking and painting — experiences that help me think differently and approach problems from new angles.

- 🌍 **Open to Opportunities**: Full-Stack / Backend Software Engineering roles (Europe & Remote).

- 📫 **Reach Me**: ismailsariarslan7@gmail.com.

---

<h3 align="center" style="color: #f8f9fa;">Connect with me:</h3>
<p align="center">
...
<p align="center">
  <img src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=krookskala&theme=github_dark" />
</p>
